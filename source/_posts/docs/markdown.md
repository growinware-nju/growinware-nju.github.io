...
Markdown是一种既对人友好也对计算机友好的标记语言，是目前互联网上书写文档最流行的语言之一。这份转载的文档阐述了Markdown的设计动机和语法定义。

可读性对Markdown来说是最重要的。一份使用 Markdown 格式撰写的文件应该可以直接以纯文本发布，并且看起来不会像是由许多标签或是格式指令所构成。Markdown 语法受到一些既有 text-to-HTML 格式的影响，包括 [Setext] [1]、[atx] [2]、[Textile] [3]、[reStructuredText] [4]、[Grutatext] [5] 和 [EtText] [6]，而最大灵感来源其实是纯文本电子邮件的格式。
...
本文转载自[Github](转载自https://github.com/riku/Markdown-Syntax-CN)，请阅读原文。
